...
function saveImages(predictions, prefix) {
 ...
 */
function mapAspectRatio(aspectRatio = '1:1') {
    ...
    if (aspectRatio === '2:3' || aspectRatio === '4:5')
        return '3:4';
    if (aspectRatio === '3:2' || aspectRatio === '5:4')
        return '4:3';
    if (aspectRatio === '21:9')
        return '16:9';
    return '1:1';
...
// ============================================================================
export const googleImagenProvider = {
    id: 'google-imagen',
...
//# sourceMappingURL=google-imagen.js.map