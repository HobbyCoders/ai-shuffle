 ...
 */
export async function collaborateAI(input) {
 ...
 */
export async function getSecondOpinion(content, provider = 'openai', focus) {
 ...
 */
export async function getConsensus(question, providers = ['openai', 'google']) {
