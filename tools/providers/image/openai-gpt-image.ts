 ...
 */
function aspectRatioToSize(aspectRatio: string = '1:1'): string {
 ...
 */
function imageSizeToQuality(imageSize: string = '1K'): string {
...
function saveImages(imagesData: Array<{ b64_json?: string; url?: string }>, prefix: string, format: string = 'png'): GeneratedImage[] {
...
export const openaiGptImageProvider: ImageProvider = {
  id: 'openai-gpt-image',
