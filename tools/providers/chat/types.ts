...
import { ProviderCredentials, ModelInfo, ModelCapability } from '../types.js';
...
export type ChatCapability =
  ...
  | 'long_context'   // Extended context window (100k+)
