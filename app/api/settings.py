...
NANO_BANANA_MODELS = {
    "gemini-2.0-flash-preview-image-generation": {
        ...
        "description": "Fast image generation, stable model - ~$0.039/image",
        "price_per_image": 0.039
    },
    "gemini-2.5-flash-image": {
        "name": "Nano Banana 2 (Gemini 2.5 Flash)",
        "description": "Faster generation with improved quality - ~$0.039/image",
        "price_per_image": 0.039
    },
    "gemini-3-pro-image-preview": {
        "name": "Nano Banana Pro (Gemini 3 Pro)",
        "description": "Studio-quality, better text rendering, 2K/4K support - ~$0.13/image",
        "price_per_image": 0.13
    }
}
